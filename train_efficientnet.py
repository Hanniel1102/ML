...
def train_efficientnet(input_folder, output_folder):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train EfficientNet model for eye disease classification.")
    ...
    train_efficientnet(args.input_folder, args.output_folder)
